...
public class JsonParser {
    ...
    public static JSONObject setObj2JsonObject(Object obj) throws IllegalArgumentException, IllegalAccessException,
            JSONException {
        ...
        for (int i = 0, j = fs.length; i < j; i++) {
            ...
            } else if (o instanceof Double || o instanceof Integer || o instanceof Float || o instanceof Long
                    || o instanceof String) {
    ...
    public static JSONArray setObj2JsonArray(Object o) throws IllegalArgumentException, IllegalAccessException,
            JSONException {
        ...
        for (int a = 0, b = list.size(); a < b; a++) {
            ...
            if (o1 == null)
                continue;
            if (o1 instanceof Double || o1 instanceof Integer || o1 instanceof Float || o1 instanceof Long
     ...
     * @param content
     */
    public static void setJson2Obj(Object obj, String content) throws JSONException, IllegalArgumentException,
    ...
    public static void setJson2Obj(Object obj, JSONObject json) throws JSONException, IllegalArgumentException,
            IllegalAccessException, InvocationTargetException, InstantiationException, ClassNotFoundException {
        ...
        for (int i = 0, j = mtd.length; i < j; i++) {
            ...
            if (value instanceof JSONObject) {
                ...
                if (!c.isAssignableFrom(ArrayList.class))
                    continue;
                ParameterizedType p = (ParameterizedType) mtd[i].getGenericParameterTypes()[0];
                Class c2 = Class.forName(p.getActualTypeArguments()[0].toString().substring(6));
    ...
    public static void setJson2Obj(List objList, JSONArray jsonArr, Class objClass) {
